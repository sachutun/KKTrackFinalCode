        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              ...
              <div class="clearfix"></div>
 <form id="FormId" action="hidepricesale.jsp" method="post" class="form-horizontal form-label-left">
...
String sql ="SELECT *,SUM(c.ARR*b.qty) as slc FROM Sale s inner join BillDetails b on s.Id=b.DC inner join CodeList c on b.Code=c.Code WHERE  month(Date)= month(CURRENT_DATE) group by s.Id";
if (branch!=null && branch.length()!=0 )
	sql1 ="SELECT *,SUM(c.ARR*b.qty) as slc FROM Sale s inner join BillDetails b on s.Id=b.DC inner join CodeList c on b.Code=c.Code WHERE  month(Date)= month(CURRENT_DATE) ";
...
<td class="admin"><%=rs.getString("ARR") %></td>
...
<%  if(type.equals("Neft"))
                          ...
                          rs2 = st2.executeQuery("SELECT * FROM BankDetails where Type='sale' and Id="+primaryKey);
                          while(rs2.next())
                        {
                        	%>
                        ...
                        <% } 
                          ...
                          rs2 = st2.executeQuery("SELECT * FROM ChequeDetails where Type='sale' and Id="+primaryKey);
                          while(rs2.next())
                        {
                        	%>
                        <td width="100%"><table id="" class="table table-striped table-bordered">
...
/*  table.rows().each( function (idx) {
    table.row( idx ).child.show();
} );  */
/* var table2=$('#ex2').DataTable( {
	"processing": true,
      ...
      scrollY:        '53vh',
        ...
        "createdRow": function ( row, data, index ) {
	         ...
	         if($('td', row).eq(6).html()<$('td', row).eq(8).html())
	        	 {
	        	 
            $('td', row).eq(0).css('colour','red');
	        	 }
        }
} ); */
