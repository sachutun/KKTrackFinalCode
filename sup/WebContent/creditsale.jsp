             ...
             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                 <div class="menu_section">
                  ...
                  <ul class="nav child_menu">
                      ...
                      <li  class=admin><a href="printpurchase.jsp">Print Purchase</a></li>
                      <li class="admin"><a>Purchase Returns</a>
                      <ul class="nav child_menu">
...
%> 
        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <form id="FormId" action="creditsale.jsp" method="post" class="form-horizontal form-label-left">
...
String sql1 ="SELECT DISTINCT Sale.Id, Sale.Branch, Sale.Date, Sale.DCNumber, Sale.CustomerName, Sale.CustomerNumber, Sale.Type, Sale.TotalPrice, Sale.AmountPaid, Sale.BalanceAmount FROM Sale where BalanceAmount>0";
String whr="";
...
<td class="admin price"><%=rs.getInt("LC") %></td>
