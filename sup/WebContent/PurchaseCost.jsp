          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h1>Purchase Costs <!-- <small>Some examples to get you started</small> --></h1>
              </div>
...
<form action="PurchaseCost.jsp" method="get" class="form-horizontal form-label-left">
...
<!--                  <a class="hide4acc&man" href="editexpense.jsp">   <button type="button" class="btn btn-warning">Edit Expenses</button></a> -->
                   <a class="hide4acc&man" href="editpurchasecost.jsp">   <button type="button" class="btn btn-warning">Edit Purchase Costs</button></a>
...
if(role!=null && role=="2")
{
	$( '[class*="branch"]' ).hide();
		    ...
		    if(ubran!=null && ((ubran=="Workshop")||(ubran=="Barhi")))
	  		...
	  		iif(ubran!=null && ((ubran=="Workshop")||(ubran=="Workshop2")))
	  			{
