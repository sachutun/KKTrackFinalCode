...
try{ 
  ...
  /*   preparedStatement=connection.createStatement();
    ...
    preparedStatement = conn.prepareStatement("DELETE FROM Expenses WHERE id = ?");
    preparedStatement.setInt(1,d);
    preparedStatement.executeUpdate();
     response.sendRedirect("editexpense.jsp?res=1"); // redirect to JSP one, which will again reload.
}catch (Exception e) {
    	 e.printStackTrace();
    	 }
%>