...
%> 
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h1>Sale Return Form <!-- <small>Some examples to get you started</small> --></h1>
              </div>
 ...
 <br/> 
                  ...
                  <a href="viewsalereturn.jsp" style="color:white;">  <button type="button" class="btn btn-info">View Sale Return</button></a>

                 <a href="saleReturn.jsp" style="color:white;">   <button type="button" class="btn btn-warning">Go Back to Sale Return</button></a>
             </div>   
...
<td><strong>Type:</strong> <%=resultSet.getString("Type") %></td></tr>
...
<td><%=bqty%></td>
<td style="width: 10%;">          
                <input id="dq<%=i %>" name="dq<%=i %>" value="0" style="width: 80%;margin-left: 7%;" min="0" max="<%=bqty%>" type="number" > 
...
</tbody> </table><button type="submit" class="btn btn-success" style="float:right" onclick="chsn(<%=i%>)">Return Items </button></form>
