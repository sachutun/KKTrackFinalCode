...
String Tbranch = request.getParameter("Tbranch"); */
             ...
             <div style=" float:right; margin-right: 10px;">
              ...
              <a class="acc" href="ibtform.jsp"><button type="button" class="btn btn-success">Add </button></a>

                   <a  href="viewIBT.jsp"> <button type="button" class="btn btn-info">View </button></a>
                   
                   <a class="acc" href="editIBT.jsp" style="color:white;">   <button type="button" class="btn btn-warning">Edit</button></a>
             </div>       
