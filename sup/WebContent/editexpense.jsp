...
%> 
        ...
        <div class="right_col " role="main">
          <div class="">
            ...
            <form action="editexpense.jsp" method="get">
        ...
        <br/>
              ...
              <a href="expenseform.jsp"><button type="button" class="btn btn-success">Add </button></a>
                  ...
                  <a href="expenses.jsp" style="color:white;">  <button type="button" class="btn btn-info">View </button></a>

                 <a href="editexpense.jsp" style="color:white;">   <button type="button" class="btn btn-warning">Edit</button></a>
