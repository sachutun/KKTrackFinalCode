          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h1>Bin Location Adjustment <!-- <small>Some examples to get you started</small> --></h1>
              </div>
            <div class="clearfix"></div>
...
/*  else if(r=="2")
     ...
     %> 
           ...
           <form id="FormId" action="binlocupdate.jsp" method="post" class="form-horizontal form-label-left">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
              <form action="binupdate.jsp" method="get">        
...
<td style="width: 10%;">          
                <input id="nbl<%=code %>" name="nbl<%=code %>" style="width: 80%;margin-left: 7%;" type="text" min=0> 
