...
%> 
     ...
     <div style=" float:right; margin-right: 10px; margin-top:-20px">
                 ...
                 <a href="" style="color:white;">   <button type="button" class="btn btn-warning">Edit</button></a>
                    ...
                    <div class="form-group"> -->
                      ...
                      <div class="form-group" style="margin-left:-3%"> 
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-3">
                          ...
                          <label class="control-label col-md-1 col-sm-1 col-xs-2" >ARR:<span class="required">*</span>
                        </label>
                        <div class="col-md-2 col-sm-2 col-xs-4">
                          <input id="arr1" class="form-control col-md-7 col-xs-12" required="required" type="number" name="arr" step="any" onchange="calculatetax(1)" min=0>
                        </div>
                 <!--      </div>
                      <div class="form-group"> -->
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-2">
                          <input id="qty1" class="form-control col-md-7 col-xs-12" required="required" type="number" name="qty" onchange="calculateTotal(1)" min=0>
                        </div>
                        <label class="control-label col-md-1 col-sm-1 col-xs-2">Total:</label>
                        <div class="col-md-1 col-sm-1 col-xs-2">
                          <input id="totalprice1" class="form-control col-md-7 col-xs-12"  type="text"  name="totalprice" readonly="readonly">
                        </div>
                   ...
                   <!--    </div>
                      <div class="form-group"> -->
                        <label class="control-label col-md-1 col-sm-1 col-xs-2">Tax:</label>
                        <div class="col-md-1 col-sm-1 col-xs-2">
                          <input id="tax1" class="form-control col-md-7 col-xs-12"  type="text" name="tax" readonly="readonly">
                        </div>
                      <!-- </div>
                    ...
                    <!--     <label class="control-label col-md-1 col-sm-1 col-xs-2">Min Price:</label>
                      ...
                      <label class="control-label col-md-1 col-sm-1 col-xs-2">Total with tax:</label>
                        <div class="col-md-1 col-sm-1 col-xs-2">
...
var da=dv[2]+'-'+dv[0]+'-'+dv[1];
 ...
 function calculateTotal(i)
 {
 	if(document.getElementById("qty"+i).value!=null)
 		{
 	var totalprice=document.getElementById("qty"+i).value*document.getElementById("arr"+i).value;
 	document.getElementById("totalprice"+i).value=totalprice;
 	var tax=parseFloat(document.getElementById('tax'+i).value);
 	var totntax=document.getElementById("qty"+i).value*(parseFloat(document.getElementById("arr"+i).value)+tax);
	document.getElementById("totntax"+i).value=totntax;
	  ...
	  totp+=parseFloat(document.getElementById("totalprice"+x).value);
	  ftotal+=parseFloat(document.getElementById("totntax"+x).value);
		  }
	  }

    var result= totp;
    if (!isNaN(result)) {
         document.getElementById('totalARR').value = result;
     }
 		}
   ...
   var result2= tot;
     ...
     if (!isNaN(result3)) {
         document.getElementById('ftotal').value = result3;
     }
   
 }
 function calculatetax(i)
 {
 	var tax=parseFloat(document.getElementById("arr"+i).value)*0.18;
 	document.getElementById('tax'+i).value=tax;
 	calculateTotal(i);
