             ...
             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <li class="admin"><a><i class="fa fa-shopping-cart"></i> Purchase <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                      ...
                      <li><a href="returnpurchase.jsp">Enter Returned Purchase items</a></li>
                    </ul>
                      </li>
                    </ul>
                  </li>
...
%> 
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h1>Cash Transfer <!-- <small>Some examples to get you started</small> --></h1>
              </div>
 ...
 <a href="CashTransfer.jsp" style="color:white;">   <button type="button" class="btn btn-info" style="background: #f19292;border: 1px solid #f19292;"> View Cash Transfers</button></a>
                 <a href="editcash.jsp">   <button type="button" class="btn btn-warning">Edit Cash Transfer</button></a>
             </div>       
