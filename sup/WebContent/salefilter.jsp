...
rs=	 stmt.executeQuery("SELECT DISTINCT Sales.Branch, Sales.Date, Sales.DCNumber, Sales.Code, Inventory.Machine, Inventory.PartNo, Inventory.Description, Inventory.MaxPrice, Inventory.MinPrice, Sales.Price, Sales.Qty, Sales.TotalPrice, Sales.CustomerName, Sales.CustomerMobile, Sales.Type, Sales.AmountPaid FROM Sales INNER JOIN Inventory ON Sales.Code=Inventory.Code ");
 ...
 b+="<thead> <tr><tr><th>Branch</th> <th>Date</th><th>DC Number</th> <th>Code</th>  <th>Description</th>  <th>Sale Price</th> <th>Quantity</th><th>Total price</th><th>Customer Name</th><th>Customer Number</th><th>Amount Paid</th><th>Type</th> <th>Machine</th><th>Part No</th> <th>Max Price</th><th>Min Price</th></tr></thead><tbody>";
   while(rs.next()){
 b+="<tr class=\"odd gradeX\"><td>"+rs.getString("Branch")+"</td><td>"+rs.getString("Date")+"</td><td>"+rs.getString("DCNumber")+"</td><td>"+rs.getString("Code")+"</td><td>"+rs.getString("Description")+"</td><td>"+rs.getString("Price")+"</td><td>"+rs.getString("Qty")+"</td><td>"+rs.getString("TotalPrice")+"</td><td>"+rs.getString("CustomerName")+"</td><td>"+rs.getString("CustomerMobile")+"</td><td>"+rs.getString("AmountPaid")+"</td><td>"+rs.getString("Type")+"</td><td>"+rs.getString("Machine")+"</td><td>"+rs.getString("PartNo")+"</td><td>"+rs.getString("MaxPrice")+"</td><td>"+rs.getString("MinPrice")+"</td></tr>";
