          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h1>Modification <!-- <small>Some examples to get you started</small> --></h1>
              </div>
            <div class="clearfix"></div>
...
/*  else if(r=="2")
     ...
     %> 
           ...
           <form id="FormId" action="modify.jsp" method="post" class="form-horizontal form-label-left">
...
String sql1 ="SELECT * FROM CodeList c INNER JOIN NewInventory n ON c.Code=n.Code where n.Code in ('"+ocode+"','"+ncode+"') and Branch='"+branch+"'";
//System.out.println(sql1);

if(ocode!=null && ncode!=null && branch!=null)
{
...
</tbody> </table><!-- <button type="button" class="btn btn-success" style="margin-bottom: 1px;margin-left: 2%;" onclick="this.form.submit()">Go </button> -->
