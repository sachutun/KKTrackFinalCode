...
float totaltax=Float.parseFloat(total)-Float.parseFloat(totalARR);
    ...
    connection = DriverManager.getConnection(url, username, password);    		  
       ...
       int x=st.executeUpdate("INSERT INTO Manufacturing (InvoiceNumber, Branch, Date, TotalPrice, ManufacturerName, Tax, Comments) values ('"+ innumber+"', '"+branch+"', '"+date+"','"+total+"', '"+manName+"',  '"+totaltax+"', '"+comments+"')");
       
       String sql="Select Max(Id) from Manufacturing";
...
preparedStatement2.setString(1,arrValues[i]);
preparedStatement2.setString(2,String.valueOf(minp));
preparedStatement2.setString(3,manName);
preparedStatement2.setString(4,String.valueOf(LC));
...
int y=st2.executeUpdate(isql);
       ...
       response.sendRedirect("addItem.jsp?res=1");
