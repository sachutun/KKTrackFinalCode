...
/*     Connection conn = ConnectManager.getConnection(); */
  ...
  /*   	 Context context = new InitialContext();
    ...
    try {
        ...
        String globeSearch =  " where Branch like '%"+searchTerm+"%'"+ " or n.Code ="+searchTerm+ " or Description like '%"+searchTerm+"%'"+ " or PartNo like '%"+searchTerm+"%'"+ " or Grp like '%"+searchTerm+"%'"+ " or Machine like '%"+searchTerm+"%'"; 
