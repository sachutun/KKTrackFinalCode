          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                <div class="menu_section">
                  ...
                  <li id="exp"><a><i class="fa fa-inr"></i> Expenses <span class="fa fa-chevron-down"></span></a>
          ...
          <div class="">
            ...
            <div class="clearfix"></div>
             ...
             <div class="col-md-3 col-sm-3 col-xs-3 admin" id="br">
              ...
              <a class="acc" href="AddCode.jsp"><button type="button" class="btn btn-success">Add </button></a>

                   <a href="viewinventory.jsp"> <button type="button" class="btn btn-info">View </button></a>
                    <a class="acc" href="inventoryAdjustment.jsp" style="color:white;">   <button type="button" class="btn btn-warning admin">Adjust</button></a>
