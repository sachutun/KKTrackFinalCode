        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              ...
              <div class="clearfix"></div>
 <form id="FormId" action="PriceCheck.jsp" method="post" class="form-horizontal form-label-left">
...
int primaryKey=0;
String sqlc="";
String o=" order by s.Id Desc Limit 5";
                    ...
                    <table id="ex" class="table table-striped table-bordered dt-responsive" width="100%">
                      <thead>
                        <tr>
                           ...
                           <tfoot>
            <tr >
                <th colspan="2" style="text-align:right">Avg Price:</th>
                <th colspan="2" ></th>
            </tr>
        </tfoot>
                        <tbody id="country">
