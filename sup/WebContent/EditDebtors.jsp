...
var table= $('#ex').DataTable( {
     ...
     "columnDefs": [
       ...
       "sAjaxSource":"GetDebtors.jsp?ubranch="+ubran+"&role="+role+"&br="+str,
       scrollY:        '50vh',
       scrollCollapse: true,
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="EditDebtors.jsp" class="site_title"><i class="fa fa-line-chart"></i> <span>KK Track</span></a>
            </div>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h1>Edit Debtors <!-- <small>Some examples to get you started</small> --></h1>
              </div>
...
var table=$('#ex').DataTable( {
	        ...
	        "sAjaxSource":"GetDebtors.jsp?ubranch="+ubran+"&role="+role,
